...
E_D("replace into `v9_member_menu` values('1','member_init','0','member','index','init','t=0','0','1','','');");
E_D("replace into `v9_member_menu` values('2','account_manage','0','member','index','account_manage','t=1','0','1','','');");
