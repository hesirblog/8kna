...
E_D("replace into `v9_urlrule` values('18','content','show','0','content-{\$catid}-{\$id}-{\$page}.html','content-1-2-1.html');");
E_D("replace into `v9_urlrule` values('30','content','category','0','list-{\$catid}-{\$page}.html','list-1-1.html');");
E_D("replace into `v9_urlrule` values('31','content','show','1','{\$catdir}/{\$catid}-{\$id}-{\$page}.html','news/1-2-1.html');");
E_D("replace into `v9_urlrule` values('32','content','category','1','{\$catdir}/index.html|{\$catdir}/list-{\$catdir}-{\$page}.html','news/list-news-1.html');");
E_D("replace into `v9_urlrule` values('33','content','category','1','{\$categorydir}{\$catdir}/index.html','/page');");
