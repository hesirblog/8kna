<?php return array (
  ...
  array (
    ...
    array (
      ...
      'index.html' => '网站首页',
      'list.html' => '列表页',
      'list_case.html' => '客片欣赏列表页',
      'list_location.html' => '外景展示列表页',
      'list_service.html' => '服务报价列表页',
      'list_dress.html' => '爱情微电影列表页',
      'list_download.html' => '下载列表页',
      'list_picture.html' => '图片列表页',
      'message.html' => '消息提示页',
      'page.html' => '单网页',
      'page_about.html' => '关于我们单页',
      'page_order.html' => '在线订单单页',
      'page_contact.html' => '联系我们单页',
      'rss.html' => 'RSS页',
      'search.html' => '搜索',
      'show.html' => '文章内容页',
      'show_location.html' => '外景展示内容页',
      'show_service.html' => '服务报价内容页',
      'show_dress.html' => '爱情微电影内容页',
    ...
    'templates|8kna|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|8kna|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|8kna|yp|com_8kna' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|8kna|comment' => 
    array (
